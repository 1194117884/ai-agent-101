...
type UploadSubmission = { id: string; submittedBy: string; submitterName?: string | null; fileName: string; mimeType: string; fileSize: number; objectKey?: string | null; status: "queued" | "processing" | "completed" | "failed"; attempt: number; conversion?: string | null; characterCount: number; partCount: number; duplicateCount: number; error?: string | null; createdAt: string; updatedAt: string };
...
export function KnowledgeManager() {
  ...
  const uploadAttentionCount = submissions.filter((submission) => submission.status !== "completed").length;
