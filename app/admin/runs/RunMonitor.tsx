...
type Metadata = { delivery?: { mode?: string; provider?: string; reason?: string }; runtime?: { durationMs?: number; attempts?: Attempt[]; toolCalls?: ToolCall[]; termination?: string }; retrieval?: { mode?: string; matches?: Match[]; conflicts?: unknown[] }; userFeedback?: { rating?: "helpful" | "unhelpful"; reason?: string; createdAt?: string } };
